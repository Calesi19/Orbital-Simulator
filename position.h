...
/*********************************************
 * COMPUTE ALTITUDE
 * Find the altitude of a position
 *********************************************/
inline double computeAltitude(const Position& pos1)
{
    return sqrt((pos1.getMetersX() * pos1.getMetersX()) +
        (pos1.getMetersY() * pos1.getMetersY())) - RAD_EARTH;
}
